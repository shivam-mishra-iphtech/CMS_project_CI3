        ...
        <div class="col-md-6">
            <div class="card text-center shadow-lg p-4">
                <div class="position-absolute top-0 end-0 mt-2 me-2">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#editProfileModal" class="btn btn-light btn-sm shadow-sm">
                        <i class="bi bi-pen"></i>
                    </a>
                </div>
                <div class="card-body">
...
<!-- Bootstrap 5 Modal -->
<div class=" w-80 modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
                ...
                <?php echo form_open_multipart(site_url('WebController/update_user')); ?>
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <div class="upload-container position-relative d-inline-block p-2 border rounded" 
                            ...
                            <!-- Image Preview -->
                            <img id="imagePreview" src="<?php echo base_url('public/userImage/' . (!empty($user_image) ? $user_image : 'default.png')); ?>" 
                                class="img-fluid rounded-circle shadow" 
                                style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                            
                            <!-- Hidden File Input -->
                            <input type="file" class="d-none" id="fileInput" name="profile_image" accept="image/*" onchange="previewImage(event)">
                        </div>
