            ...
            <div class="collapse navbar-collapse" id="sidebarCollapse">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 fw-medium">
                    ...
                    <li class="nav-item mx-2">
                        <a class="nav-link active" aria-current="page" href="<?php echo site_url('AdminController/dashboard')?>">
                    ...
                    <li class="nav-item mx-2">
                        ...
                        <ul class="user-menu list-unstyled collapse">
                            <li>
                                <a class="dropdown-item py-2 px-4 d-flex align-items-center" href="<?php echo site_url('AdminController/user_list')?>">
                                    <i class="bi bi-list-task me-1 text-primary"></i>
                                    User List
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 px-4 d-flex align-items-center" href="<?php echo site_url('AdminController/add_user')?>">
                ...
                <style>
                    ...
                    .user-menu {
                        display: none;
                        padding-left: 20px; /* Aligns with Users link */
                    }
