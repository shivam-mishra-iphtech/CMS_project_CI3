    ...
    <header class="bg-surface-primary border-bottom py-4">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h2 mb-0 ls-tight">Edit User Data</h1>
                    ...
                    <?php if($user->role == 2): ?>
                        <div class=" w-50 mb-4">
                            ...
                            <div class="upload-container text-center p-3 border rounded" 
                                ...
                                <input type="file" class="upload-input d-none" id="fileInput" name="profile_image" accept="image/*"
                                    onchange="previewImage(event)">
                                <div class="upload-preview mt-2">
                                    <?php if (!empty($user->profile_image)): ?>
                                        <img src="<?= base_url('uploads/'.$user->profile_image); ?>" 
                                            id="imagePreview" class="" 
