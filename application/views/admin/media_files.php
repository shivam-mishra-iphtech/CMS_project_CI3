                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-3">
                            <button class="btn btn-sm btn-primary" id="uploadButton" data-bs-toggle="modal" data-bs-target="#uploadModal">
                    ...
                    <div class="row g-4" id="mediaGrid">
                        <?php if(!empty($media_files)): ?>
                            ...
                            <div class="col-xxl-2 col-xl-3 col-lg-4 col-md-6 media-item" 
                                 ...
                                 data-date="<?= strtotime($file->upload_date) ?>"
                                ...
                                <div class="card card-hover h-100">
                                        ...
                                        <?php else: ?>
                                            <div class="position-relative bg-light" style="height: 150px;">
                                                <div class="d-flex flex-column align-items-center justify-content-center h-100 text-primary">
                                                    ...
                                                    <span class="mt-2 fw-medium text-truncate px-2" style="max-width: 100%;"><?= $file->media_file_name ?></span>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <span class="position-absolute top-0 end-0 m-2 badge <?= $file->media_file_type == 'image' ? 'bg-primary' : ($file->media_file_type == 'gif' ? 'bg-success' : 'bg-danger') ?>">
                                            <?= strtoupper($file->media_file_type) ?>
                                        </span>
                                        <!-- <div class="card-img-overlay d-flex align-items-center justify-content-center bg-none bg-opacity-0 hover-opacity-75 transition-opacity"> -->
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <p class="small text-muted mb-0"><?= date('M d, Y', strtotime($file->upload_date)) ?></p>
                        ...
                        <?php else: ?>
                            <div class="col-12">
                                <div class="text-center py-5" id="emptyState">
                                    ...
                                    <button class="btn btn-primary mt-3" id="uploadEmptyButton" data-bs-toggle="modal" data-bs-target="#uploadModal">
                                        <i class="bi bi-upload me-2"></i> Upload Files
                                    </button>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="file_name" id="file_name" placeholder="Enter base name for files">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="dropzone border rounded p-3 text-center" id="fileDropzone">
                            ...
                            <input class="form-control d-none" type="file" id="media_file" name="media_file[]" multiple required>
                            <button type="button" class="btn btn-sm btn-outline-primary" id="browseFilesBtn">Select Files</button>
                        </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="" class="img-fluid d-none" id="imagePreview" style="max-height: 70vh;">
...
<style>
    ...
    .card:hover .card-img-overlay .btn-group {
        transform: scale(1);
    }
</style>
...
<script>
    ...
    // Event handlers
    fileDropzone.addEventListener('click', (e) => e.target.id !== 'browseFilesBtn' && fileInput.click());
    ...
    ['dragenter', 'dragover', 'dragleave', 'drop'].forEach(evt => {
        fileDropzone.addEventListener(evt, e => {
            e.preventDefault();
            e.stopPropagation();
            fileDropzone.classList.toggle('active', ['dragenter', 'dragover'].includes(evt));
    ...
    document.getElementById('uploadForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                modals.upload.hide();
                 alert('Media file Upload succesfully');
                setTimeout(() => {
                    location.reload();
                }, 1500);
            }
    ...
    function filterAndSortMedia() {
        ...
        visibleItems.sort((a, b) => {
            switch(sortOption) {
                ...
                case 'size-asc': return b.dataset.size - a.dataset.size;
                case 'size-desc': return a.dataset.size - b.dataset.size;
                default: return 0;
            }
        });
    ...
    function showToast(type, message) {
        ...
        toast.className = `custom-toast toast align-items-center text-dark bg-${type} border-0 position-fixed bottom-0 end-0 m-3`;
